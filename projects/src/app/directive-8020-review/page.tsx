      ...
      <article className="mx-auto max-w-4xl px-4 sm:px-6 py-8">
        ...
        <div className="rounded-lg border border-border/50 bg-card/30 overflow-hidden my-8">
          <table className="w-full text-sm">
            ...
            <tbody>
              {mediaScores.map((row) => (
                <tr key={row.outlet} className="border-b border-border/30 last:border-0">
                  <td className="px-4 py-3 font-semibold text-foreground">
                    <a href={row.href} target="_blank" rel="noreferrer" className="hover:text-d8020">
                      {row.outlet}
                    </a>
                  </td>
                  <td className="px-4 py-3 text-d8020 font-semibold">{row.score}</td>
            ...
            <tbody>
              {buyAdvice.map(([player, verdict, reason]) => (
                <tr key={player} className="border-b border-border/30 last:border-0">
                  ...
                  <td className="px-4 py-3 text-d8020 font-semibold">{verdict}</td>
