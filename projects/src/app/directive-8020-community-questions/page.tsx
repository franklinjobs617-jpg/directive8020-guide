...
export default function CommunityQuestionsPage() {
 ...
 {questions.map((item) => (
 <section key={item.q} className="rounded-lg border border-border bg-white p-5">
 ...
 <a href={item.href} className="text-sm font-semibold text-foreground underline-offset-4 hover:underline">
 Read the full guide
 </a>
 </section>
 ))}
