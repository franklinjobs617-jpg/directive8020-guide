...
const stealthChecklist = [
  ['Movement', 'Crouch-walk near threats; sprint only when the game clearly demands escape.'],
  ['Line of sight', 'Break sight around corners, equipment, doors, and ship structures.'],
  ['Sound', 'Avoid unnecessary movement in metal corridors and threat-heavy rooms.'],
  ['Distractions', 'If noisemakers or throwable objects appear, log where they spawn and what they affect.'],
  ['Hiding', 'Use cover before QTE panic starts; do not wait until the creature is already close.'],
      ...
      <article className="mx-auto max-w-4xl px-4 sm:px-6 py-8">
        ...
        <div className="prose-game">
          ...
          <p>
            ...
            rule: <strong>slow movement, cover, and information are safer than
            speed</strong>. The mimic threat means a chase is not always just a
            ...
            <tbody>
              {stealthChecklist.map(([label, value]) => (
                <tr key={label} className="border-b border-border/30 last:border-0">
                  <td className="px-4 py-3 text-foreground font-medium w-36">{label}</td>
        ...
        <div className="prose-game">
          ...
          <ul>
            ...
            <li>Use camera angles to check whether a corridor is staged for pursuit.</li>
            <li>Do not sprint after a noise unless the game forces an escape.</li>
            <li>Record if a stealth failure causes injury, item loss, separation, or death.</li>
          </ul>
