    ...
    <article className="mx-auto max-w-4xl px-4 py-8 sm:px-6">
      ...
      <div className="prose-game">
        ...
        <ul>
          ...
          <li>
            <strong>System requirements & Steam Deck checks</strong> —
            verified performance data, settings recommendations, and
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          {featuredGames.map((game) => (
            <Link
              key={game.href}
              href={game.href}
              className="rounded-md border border-border/40 bg-card/30 p-4 transition-colors hover:border-emerald-400/40"
            >
        ...
        <p>
          ...
          <Link href="/steam-deck" className="text-emerald-300 hover:underline">
        ...
        <p>
          ...
          <a href={`mailto:${contactEmail}`} className="text-emerald-300 hover:underline">
            {contactEmail}
          </a>.
        </p>
        <p>
