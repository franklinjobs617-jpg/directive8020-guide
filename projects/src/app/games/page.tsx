...
const gameCards = [
 ...
 label: "Cozy postal management sim",
 body: "Release date, price, system requirements, and co-op details for this cat-themed postal sim from Maracas Studio launching July 9, 2026.",
 image: catMailCoImages.card,
 },
 {
