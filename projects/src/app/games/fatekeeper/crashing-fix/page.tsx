...
export default function FatekeeperCrashingPage() {
 ...
 <div key={item.step} className="rounded-lg border border-border bg-mist p-5">
 ...
 <div className="p-5">
 <code className="text-sm text-foreground">-dx11</code>
 ...
 <div key={item.setting} className="flex flex-wrap items-center gap-4 rounded-md border border-border bg-mist p-4">
 <div className="min-w-[140px]">
 <p className="text-sm font-semibold text-foreground">{item.setting}</p>
 </div>
 <div className="flex-1">
 <p className="text-sm text-foreground font-medium">Recommended: {item.recommendation}</p>
 ...
 <div className="mt-3 rounded-lg border border-border bg-mist p-4">
