    ...
    >
      ...
      <div className="space-y-10">
        {voidlingSpecies.map((species) => {
          ...
          return (
            <section key={species.slug} id={species.slug} className="rounded-lg border border-border/50 bg-card/30 p-5">
              <div className="mb-5">
                <p className="mb-2 text-xs font-semibold uppercase tracking-wider text-d8020">
                  {entries.length} entries
                </p>
                <h2 className="text-2xl font-black text-foreground">{species.name}</h2>
