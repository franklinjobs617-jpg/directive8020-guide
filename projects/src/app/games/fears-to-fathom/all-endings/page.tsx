 ...
 return (
  <main className="mx-auto max-w-3xl px-4 py-6 sm:px-6 sm:py-8">
   ...
   <p className="mt-4 text-base text-muted-foreground leading-relaxed">
    ...
    and two death endings. The True Ending is missable because the game never tells you to unhook the trailer —
    this guide covers every step so you do not miss it.
   </p>
   ...
   <p className="mt-10 text-xs text-muted-foreground">
    Data source: in-game testing, TheGamer, ShowGamer, FuxoLogy, and community reports. Last updated June 15, 2026.
   </p>
  </main>
 );
}
