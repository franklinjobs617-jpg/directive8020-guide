...
const issues = [
 {
  title: 'Game Is Too Dark â?Cannot See Anything',
  severity: 'high',
  fix: 'Scratch Creek removed the VHS filter toggle that was available in previous episodes. There is no in-game brightness setting. Workarounds:<br/><br/>1. <strong>Increase your monitor/TV brightness</strong> â?set it to 80-90% for this game.<br/>2. <strong>Use your graphics card control panel:</strong> NVIDIA Control Panel â?Adjust desktop color settings â?increase Brightness + Gamma. AMD Radeon Software â?Display â?Custom Color â?increase Brightness.<br/>3. <strong>Calibrate before the dark sections:</strong> The church basement and 3:33 AM chase are the darkest parts. Adjust your settings during the daytime sections so you are ready.<br/>4. <strong>Use the flashlight properly:</strong> The flashlight has limited range. Point it at the ground ahead of you, not straight forward â?this illuminates more of your path.',
 ...
 {
  title: 'Stuck at Final Chase â?Trailer Will Not Unhook',
  severity: 'high',
  fix: 'This is the #1 stuck point. The game gives zero prompts about unhooking the trailer. Here is the exact fix:<br/><br/>1. After hiding in the trailer and waiting for the man to enter the house, <strong>both players jump out</strong>.<br/>2. <strong>Only ONE player approaches the hitch</strong> (the connection point between car and trailer). If both players crowd the hitch, the interaction prompt may not appear.<br/>3. Walk slowly toward the hitch from the side. Stop and wait â?the prompt can take a moment to register.<br/>4. If the prompt still does not appear: <strong>step away, stop pressing all buttons, and re-approach from a clean angle</strong> (directly from the driver\'s side).<br/>5. Once the trailer is unhooked, both players get in the car and drive.<br/><br/><strong>Do NOT try to escape on foot.</strong> You must use the car. Do NOT drive with the trailer attached â?the car stalls instantly.',
  note: 'This is not a bug â?it is a deliberate puzzle with poor communication. The developer intended for players to figure out the unhook step themselves.',
 },
 {
  title: 'Matchmaking Not Working â?Cannot Find a Partner',
  severity: 'medium',
 ...
 },
 {
  ...
  severity: 'low',
  fix: 'Some achievements require BOTH players to meet the condition:<br/><br/>1. <strong>Eavesdropper</strong> and <strong>Down in the Dark</strong> are per-player. If you are playing as Tessa and Marcus triggers one, YOU do not get it â?you need to play as Marcus yourself.<br/>2. <strong>Survivor</strong> requires both players to complete the escape. If one player disconnects during the finale, the achievement may not unlock.<br/>3. <strong>Holy Cow</strong> (Cow Clicker 100M points) takes ~30 minutes of continuous clicking. It does not save progress if you exit the minigame. Do it in one session.<br/>4. <strong>Who\'s Watching?</strong> and <strong>The Drifter</strong> are missable â?you cannot go back for them after passing their trigger points. Use a new save or checkpoint reload.',
 },
];
