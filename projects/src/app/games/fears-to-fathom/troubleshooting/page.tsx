...
const issues = [
 {
  ...
  severity: 'high',
  fix: 'Scratch Creek removed the VHS filter toggle that was available in previous episodes. There is no in-game brightness setting. Workarounds:<br/><br/>1. <strong>Increase your monitor/TV brightness</strong> — set it to 80-90% for this game.<br/>2. <strong>Use your graphics card control panel:</strong> NVIDIA Control Panel → Adjust desktop color settings → increase Brightness + Gamma. AMD Radeon Software → Display → Custom Color → increase Brightness.<br/>3. <strong>Calibrate before the dark sections:</strong> The church basement and 3:33 AM chase are the darkest parts. Adjust your settings during the daytime sections so you are ready.<br/>4. <strong>Use the flashlight properly:</strong> The flashlight has limited range. Point it at the ground ahead of you, not straight forward — this illuminates more of your path.',
 ...
 return (
  <main className="mx-auto max-w-3xl px-4 py-6 sm:px-6 sm:py-8">
   ...
   <p className="mt-10 text-xs text-muted-foreground">
    Data source: Steam community discussions, Steam reviews, player reports on Reddit and Discord. Last updated June 15, 2026. Issues may be patched in future updates.
   </p>
  </main>
 );
}
