...
export default function StarminerTechPage() {
 ...
 <div key={item.req} className="rounded-lg border border-border bg-mist p-5">
 <h3 className="text-base font-bold text-foreground">{item.req}</h3>
 ...
 <div key={item.method} className="rounded-lg border border-border bg-white p-5">
 <div className="flex items-center justify-between mb-2">
 <h3 className="text-base font-bold text-foreground">{item.method}</h3>
 <span className="text-xs font-semibold text-foreground">{item.xp}</span>
 </div>
 ...
 <tr key={exception} className="border-b border-border last:border-0">
