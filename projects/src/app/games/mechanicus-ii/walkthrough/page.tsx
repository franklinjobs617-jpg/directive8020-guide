...
export default function MechanicusIIWalkthroughPage() {
 ...
 <Link href="/games/mechanicus-ii/beginner-guide" className="text-foreground hover:underline">
 Mechanicus II beginner guide
 </Link>
 . If the problem is faction choice or unit roles, use the{' '}
 <Link href="/games/mechanicus-ii/factions" className="text-foreground hover:underline">
