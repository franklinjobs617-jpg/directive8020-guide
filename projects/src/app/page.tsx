...
export default function HomePage() {
 ...
 <div className="site-shell grid gap-8 py-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:py-14">
 <div className="max-w-2xl">
 <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-border bg-white px-3.5 py-1.5 text-[13px] font-medium text-smoke">
 <span className="ui-pink-badge">LIVE</span>
 Launch guide updated May 12
 </div>
 <h1 className="mb-5 text-[36px] font-bold leading-[1.06] tracking-[-1.1px] text-foreground sm:text-[54px] sm:leading-[1.08] sm:tracking-[-1.39px] lg:text-[64px]">
 Directive 8020
 </h1>
 ...
 <div className="mb-5 flex max-w-xl overflow-hidden rounded-xl bg-mist">
 <div className="flex min-h-11 flex-1 items-center px-4 text-sm text-fog">
 Search endings, trophies, choices, Deck fixes
 </div>
 <Link
 href="/guides"
 ...
 <span className="text-sm font-bold text-foreground">Popular:</span>
 {[
 ['Endings', '/directive-8020-all-endings'],
 ['Save Everyone', '/directive-8020-how-to-save-everyone'],
 ['Trophy List', '/directive-8020-trophy-list'],
 ['Steam Deck', '/directive-8020-steam-deck'],
 ].map(([label, href]) => (
 <Link key={href} href={href} className="ui-pill">
 {label}
 </Link>
 ))}
 </div>
 <div className="grid max-w-xl grid-cols-2 gap-2 text-xs sm:grid-cols-3">
 {quickFacts.slice(0, 6).map(([label, value]) => (
 <div key={label} className="rounded-lg border border-border bg-mist px-3 py-2">
 ...
 <aside className="rounded-2xl bg-midnight-ink p-3">
 ...
 {[
 ['Start Spoiler-Free', '/directive-8020-beginner-tips'],
 ['Popular Questions', '/directive-8020-community-questions'],
 ...
 key={href}
 href={href}
 className="rounded-lg border border-border bg-white px-3 py-2 text-sm font-semibold text-foreground transition-colors hover:border-dribbble-pink"
 >
 {label}
 </Link>
 ))}
 ...
 <Link key={item.query} href={item.href} className="rounded-lg border border-border bg-white p-4 transition-colors hover:border-border hover:bg-mist">
 ...
 <Link key={route.href} href={route.href} className="group overflow-hidden rounded-lg border border-border bg-white transition-colors hover:border-border">
 <div className="relative aspect-video">
 ...
 <div className="p-4">
 <h3 className="text-sm font-bold text-foreground group-hover:text-foreground">{route.title}</h3>
 ...
 <Link key={href} href={href} className="rounded-md border border-border bg-mist px-3 py-2 text-sm text-muted-foreground transition-colors hover:border-border hover:text-foreground">
 {label}
 </Link>
 ))}
 </div>
 ...
 <Link href="/games" className="text-sm font-semibold text-foreground hover:underline">
 All game hubs
 </Link>
 </div>
 <div className="grid gap-4 md:grid-cols-3">
 {newGameCoverage.map((item) => (
 <Link key={item.href} href={item.href} className="group overflow-hidden rounded-lg border border-border bg-white transition-colors hover:border-border">
 <div className="relative aspect-video">
 ...
 <div className="p-5">
 <h3 className="text-base font-bold text-foreground group-hover:text-foreground">{item.title}</h3>
 ...
 <Link key={article.href} href={article.href} className="group overflow-hidden rounded-lg border border-border bg-white transition-colors hover:border-border">
 ...
 <div className="absolute inset-0 opacity-30" />
 <span className="absolute left-4 top-4 rounded border border-border bg-mist px-2 py-0.5 text-[10px] font-semibold uppercase tracking-[0.12px] text-foreground">
 {article.label}
 </span>
 </div>
 <div className="p-5">
 <h3 className="text-lg font-bold text-foreground group-hover:text-foreground">{article.title}</h3>
 ...
 <Link href="/guides" className="text-sm font-semibold text-foreground hover:underline">
 View all guides
 </Link>
 </div>
 <div className="grid gap-4 lg:grid-cols-3">
 {missionCards.map((card) => (
 <Link key={card.href} href={card.href} className="group overflow-hidden rounded-lg border border-border bg-white transition-colors hover:border-border">
 <div className="relative aspect-[16/9]">
 ...
 <div className="p-5">
 <h3 className="text-lg font-bold text-foreground group-hover:text-foreground">{card.title}</h3>
 ...
 <div key={group.title} className="rounded-lg border border-border bg-white p-5">
 <h2 className="mb-4 text-base font-bold text-foreground">{group.title}</h2>
 <div className="grid gap-2">
 {group.links.map(([label, href]) => (
 <Link key={href} href={href} className="flex items-center justify-between rounded-md px-2 py-1.5 text-sm text-muted-foreground transition-colors hover:bg-mist hover:text-foreground">
 <span>{label}</span>
 ...
 <p className="text-xs font-semibold uppercase tracking-[0.12px] text-foreground">How to use these videos</p>
 ...
 <div className="grid gap-4 border-t border-border p-4 md:grid-cols-2 lg:grid-cols-4">
 {videos.slice(4).map((video) => (
 <a
 key={video.id}
 href={`https://www.youtube.com/watch?v=${video.id}`}
 className="group overflow-hidden rounded-md border border-border bg-mist transition-colors hover:border-border"
 target="_blank"
 rel="noreferrer"
 >
 <div className="relative aspect-video">
 ...
 <Link key={item.title} href={item.href} className="rounded-lg border border-border bg-white p-5 transition-colors hover:border-border hover:bg-mist">
 ...
 <figure key={item.title} className="overflow-hidden rounded-lg border border-border bg-white">
 <div className="relative aspect-video">
 ...
 <section key={group.title} className="rounded-lg border border-border bg-white p-5">
 <h3 className="mb-4 text-base font-bold text-foreground">{group.title}</h3>
 <div className="space-y-3">
 {group.items.map((item) => (
 <Link key={item.q} href={item.href} className="block rounded-md border border-border bg-mist p-4 transition-colors hover:border-border">
