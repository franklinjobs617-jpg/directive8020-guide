...
const allGuides = [
 ...
 description: 'Brianna Young, Nolan Stafford, Laura Eisele, Samantha Cooper, Josef Cernan, cast status, mimic clues, and survival roles.',
 tag: 'Available',
 tagColor: 'text-foreground bg-mist border-border',
 ...
 description: 'Five major ending families plus named outcomes including Homeward Bound, Docked, Mask Off, Hitchhiker, Massacre, Not Alone, and Horror.',
 tag: 'Updated',
 tagColor: 'text-foreground bg-mist border-border',
 ...
 description: '44 death scenes checklist with chapter triggers, victims, avoid methods, Turning Points recovery, and death spiral notes.',
 tag: 'Death Guide',
 tagColor: 'text-foreground bg-mist border-border',
 image: '/d8020-screenshot-05.jpg',
 },
 ...
 description: 'How rewind timelines work, why changed choices need replaying forward, and how to track 100% branches.',
 tag: 'Core Mechanic',
 tagColor: 'text-foreground bg-mist border-border',
 ...
 description: '65 collectibles: 50 Secrets, 10 Simms Recordings, 5 O Death Secrets, Deluxe Heirlooms, and trophy cleanup.',
 tag: 'Collectibles',
 tagColor: 'text-foreground bg-mist border-border',
 image: '/d8020-screenshot-04.jpg',
 },
 ...
 description: 'Startup crashes, black screen, stuttering, low FPS, audio, controller, PS5, Xbox, and PC troubleshooting.',
 tag: 'Updated',
 tagColor: 'text-foreground bg-mist border-border',
 image: '/d8020-screenshot-02.jpg',
 },
 ...
 description: 'All 8 episodes from Little Star to Come True, choices, collectibles, QTEs, stealth, and Story Tree planning.',
 tag: 'Updated',
 tagColor: 'text-foreground bg-mist border-border',
 image: '/d8020-screenshot-02.jpg',
 },
...
export default function GuidesPage() {
 ...
 <h2 className="mt-1 text-[26px] font-bold leading-tight tracking-[-0.29px] text-foreground">Available Now</h2>
 </div>
 ...
 <section>
 <div className="mb-6">
 <p className="section-label text-dribbble-pink">Updated</p>
