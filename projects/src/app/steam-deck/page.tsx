...
const steamDeckGames = [
 ...
 statusColor: "text-foreground border-border bg-white",
...
export default function SteamDeckPage() {
 ...
 <h1 className="text-[42px] font-bold leading-[1.08] tracking-[-1.39px] text-foreground sm:text-[54px]">
 Steam Deck Game Guides
 </h1>
 ...
 <span className="rounded border border-border bg-white px-2.5 py-1 font-semibold text-foreground">
 ...
 <span
 className={`absolute right-3 top-3 rounded border px-2 py-0.5 text-[10px] font-semibold uppercase tracking-[0.12px] ${game.statusColor}`}
 >
 {game.status}
 </span>
 </div>
 <div className="shot-meta">
 <h3 className="text-sm font-bold text-foreground group-hover:text-dribbble-pink">
 {game.title}
 </h3>
