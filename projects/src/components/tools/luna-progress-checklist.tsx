...
export function LunaProgressChecklist({
 ...
 return (
 <section className={`my-8 rounded-lg border border-border bg-mist ${compact ? 'p-4' : 'p-5'}`}>
 <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
 <div>
 <p className="text-xs font-semibold uppercase tracking-[0.12px] text-foreground">Saved locally</p>
 ...
 <label
 key={step.id}
 className="flex cursor-pointer items-start gap-3 rounded-md border border-border bg-mist p-3"
 >
 <Checkbox
 checked={checked}
