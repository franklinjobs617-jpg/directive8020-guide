...
function getRisk(score: number) {
  ...
  if (score >= 2) {
    return {
      label: 'Watch closely',
      className: 'border-d8020/40 bg-d8020/10 text-foreground',
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <button
              type="button"
              onClick={reset}
              className="inline-flex items-center gap-2 rounded-md border border-border/60 px-3 py-2 text-sm text-muted-foreground transition-colors hover:border-d8020/60 hover:text-foreground"
            >
        ...
        <div className="mt-5 grid gap-3 lg:grid-cols-[1fr_1.2fr]">
          <div className={`rounded-lg border p-4 ${topSuspect.risk.className}`}>
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-xs font-semibold uppercase tracking-wider opacity-80">Most suspicious right now</p>
      ...
      <div className="grid gap-4 p-4 lg:grid-cols-[260px_1fr]">
        ...
        <div className="rounded-lg border border-border/50 bg-background/35 p-4">
          <div className="mb-4 flex items-center gap-4">
            <div className="relative h-20 w-20 shrink-0 overflow-hidden rounded-lg border border-d8020/30 bg-black">
              ...
              return (
                <label
                  ...
                  className={`rounded-lg border p-3 transition-colors ${
                    checked
                      ? 'border-d8020 bg-d8020/15'
                      : 'border-border/50 bg-card/30 hover:border-d8020/50'
                  }`}
                >
