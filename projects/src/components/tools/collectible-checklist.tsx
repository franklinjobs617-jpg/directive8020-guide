...
export function CollectibleChecklist() {
 ...
 <div key={item.label} className="rounded-md border border-border bg-mist p-3">
 ...
 <span className={`font-semibold ${done ? 'text-foreground line-through' : 'text-foreground'}`}>
 {item.label}
 </span>
