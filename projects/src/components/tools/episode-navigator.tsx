...
export function EpisodeNavigator({ episodes }: EpisodeNavigatorProps) {
 ...
 return (
 <section aria-labelledby="episode-navigator" className="my-10 rounded-lg border border-border bg-white p-5">
 ...
 <div className="mt-4 rounded-lg border border-border bg-mist p-4">
 <div className="mb-3 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
 <h3 className="text-lg font-bold text-foreground">{active.title}</h3>
 <Link href={active.href} className="w-fit rounded-md border border-border px-3 py-2 text-sm font-medium text-foreground hover:bg-mist">
 Open route page
 </Link>
 </div>
