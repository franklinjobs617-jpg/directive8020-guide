...
export const gag2Images = {
 icon: '/games/grow-a-garden-2/icon.webp',
 pet: (name: string) => `/games/grow-a-garden-2/pets/gag2-${name}.webp`,
 gear: (name: string) => `/games/grow-a-garden-2/gears/${name}.webp`,
 seed: (name: string) => `/games/grow-a-garden-2/seeds/${name}.webp`,
};
